...
BOT_TOKEN = environ.get('BOT_TOKEN', "6825398442:AAGXYoLUQ26P1DPfw5j_t0Wk-ZnBb11-1to")
...
AUTH_GROUP = environ.get('AUTH_GROUP')
...
RQST_LOG_CHANNEL = int(environ.get('RQST_LOG_CHANNEL', -1002087522732))
...
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', '0ft2s2mKCHOaLUKDZCcnDXCt8O63')
